...
/**
...

	{
		...
		intercept: function(next, lines, rulekey, rulevalue, ruleindex) { 	//{Optional} - intercept while building an email body. Customizing boundary block
			next();															//next - callback function
		})																	//lines - array of lines before concatinating to the boundary block
